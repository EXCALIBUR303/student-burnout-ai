...
function Navbar({ isLoggedIn, setIsLoggedIn }) {
  ...
  const privateLinks = [{ to: "/dashboard", label: "Dashboard" }, { to: "/predict", label: "Predict" }, { to: "/progress", label: "Progress" }, { to: "/flowchart", label: "Recovery" }, { to: "/professor", label: "🎓 Prof" }];
